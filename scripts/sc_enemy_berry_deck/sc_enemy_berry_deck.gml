...
//
if ob_main.playing_gym=true { enemycard_berrydeck_total=round(enemycard_berrydeck_total*1.25); } //+25%
...
else if ob_main.playing_tutorial=false and argument0=100 { enemycard_berrydeck_total=round(enemycard_berrydeck_total*1.2); } //+20% (ACE TRAINER)
