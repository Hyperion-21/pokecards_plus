...
//
if ob_main.playing_gym=true { enemycard_berrydeck_total=round(enemycard_berrydeck_total*1.15); } //+15%
else if ob_main.playing_elite=true { enemycard_berrydeck_total=round(enemycard_berrydeck_total*1.2); } //+20%
else if ob_main.playing_champion=true { enemycard_berrydeck_total=round(enemycard_berrydeck_total*1.25); } //+25%
