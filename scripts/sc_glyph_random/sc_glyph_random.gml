...
else if var_random<375 { return 03; } //100 ruthless
...
else if var_random<605 { return 07; } //75 shield
else if var_random<625 { return 08; } //20 medic
else if var_random<635 { return 09; } //10 tenacity
else if var_random<655 { return 10; } //20 bulwark
else if var_random<695 { return 11; } //40 fork attack
else if var_random<715 { return 12; } //20 vampire
else if var_random<725 { return 13; } //10 curse
else if var_random<800 { return 14; } //75 memento
//————————————————————————————————————————————————————————————————————————————————————————————————————
}