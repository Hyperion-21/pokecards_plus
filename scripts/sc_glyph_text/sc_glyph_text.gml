...
switch (argument0) {
	...
	case 01: return "// HARVEST //\nConsumed berries return to your hand (if not full) when fainting."; break;
		...
		case 13: return "// GUARD //\nMoves in front of incoming direct attacks."; break;
		case 14: return "// CURSE //\nWhen fainting, the enemy Pokemon also faints."; break;
	case 15: return "// MEMENTO //\nAllows you to draw extra cards when fainting."; break;
	//
