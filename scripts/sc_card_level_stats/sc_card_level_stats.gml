...
//
card_full_hp+=ceil(card_full_hp*((card_innate-1)/(ob_main.innate_max-1))); //max x2
card_full_atk+=ceil(card_full_atk*((card_innate-1)/(ob_main.innate_max-1))); //max x2
card_full_def+=ceil(card_full_def*((card_innate-1)/(ob_main.innate_max-1))); //max x2
//
