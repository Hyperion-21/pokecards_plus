...
//————————————————————————————————————————————————————————————————————————————————————————————————————
	...
	for (var i=0; i<enemycard_maindeck_total; i++;) {
		...
		else if i<14 { sc_enemy_deck_addcard(i,-1,1,-2,-2,-2,-1,-1); } //(4) LV 1
	}
}
//————————————————————————————————————————————————————————————————————————————————————————————————————
	...
	for (var i=0; i<enemycard_maindeck_total; i++;) {
		...
		else if i<6 { sc_enemy_deck_addcard(i,-1,4,-2,-2,-2,-1,-1); } //(4) LV 4
		else if i<12 { sc_enemy_deck_addcard(i,-1,3,-2,-2,-2,-1,-1); } //(6) LV 3
		else if i<18 { sc_enemy_deck_addcard(i,-1,2,-2,-2,-2,-1,-1); } //(6) LV 2
	}
}
//————————————————————————————————————————————————————————————————————————————————————————————————————
	...
	for (var i=0; i<enemycard_maindeck_total; i++;) {
		...
		else if i<7 { sc_enemy_deck_addcard(i,-1,5,-2,-2,-2,-1,-1); } //(5) LV 5
		else if i<15 { sc_enemy_deck_addcard(i,-1,4,-2,-2,-2,-1,-1); } //(8) LV 4
		else if i<22 { sc_enemy_deck_addcard(i,-1,3,-2,-2,-2,-1,-1); } //(7) LV 3
	}
}
//————————————————————————————————————————————————————————————————————————————————————————————————————
	...
	for (var i=0; i<enemycard_maindeck_total; i++;) {
		...
		else if i<9 { sc_enemy_deck_addcard(i,-1,6,-2,-2,-2,-1,-1); } //(6) LV 6
		else if i<18 { sc_enemy_deck_addcard(i,-1,5,-2,-2,-2,-1,-1); } //(9) LV 5
		else if i<26 { sc_enemy_deck_addcard(i,-1,4,-2,-2,-2,-1,-1); } //(8) LV 4
	}
}
//————————————————————————————————————————————————————————————————————————————————————————————————————
	...
	for (var i=0; i<enemycard_maindeck_total; i++;) {
		...
		else if i<10 { sc_enemy_deck_addcard(i,-1,7,-2,-2,-2,-1,-1); } //(7) LV 7
		else if i<20 { sc_enemy_deck_addcard(i,-1,6,-2,-2,-2,-1,-1); } //(10) LV 6
		else if i<30 { sc_enemy_deck_addcard(i,-1,5,-2,-2,-2,-1,-1); } //(10) LV 5
	}
}
//————————————————————————————————————————————————————————————————————————————————————————————————————
	...
	for (var i=0; i<enemycard_maindeck_total; i++;) {
		...
		else if i<11 { sc_enemy_deck_addcard(i,-1,8,-2,-2,-2,-1,-1); } //(7) LV 8
		else if i<23 { sc_enemy_deck_addcard(i,-1,7,-2,-2,-2,-1,-1); } //(12) LV 7
		else if i<34 { sc_enemy_deck_addcard(i,-1,6,-2,-2,-2,-1,-1); } //(11) LV 6
	}
}
//————————————————————————————————————————————————————————————————————————————————————————————————————
	...
	for (var i=0; i<enemycard_maindeck_total; i++;) {
		...
		else if i<13 { sc_enemy_deck_addcard(i,-1,9,-2,-2,-2,-1,-1); } //(9) LV 9
		else if i<26 { sc_enemy_deck_addcard(i,-1,8,-2,-2,-2,-1,-1); } //(13) LV 8
		else if i<38 { sc_enemy_deck_addcard(i,-1,7,-2,-2,-2,-1,-1); } //(12) LV 7
	}
}
//————————————————————————————————————————————————————————————————————————————————————————————————————
	...
	for (var i=0; i<enemycard_maindeck_total; i++;) {
		...
		else if i<13 { sc_enemy_deck_addcard(i,-1,10,-2,-2,-2,-1,-1); } //(8) LV 10
		else if i<27 { sc_enemy_deck_addcard(i,-1,9,-2,-2,-2,-1,-1); } //(14) LV 9
		else if i<40 { sc_enemy_deck_addcard(i,-1,8,-2,-2,-2,-1,-1); } //(13) LV 8
	}
}
//————————————————————————————————————————————————————————————————————————————————————————————————————
...
//————————————————————————————————————————————————————————————————————————————————————————————————————
	...
	for (var i=0; i<enemycard_maindeck_total; i++;) {
		...
		else if i<13 { sc_enemy_deck_addcard(i,-1,10,-2,-2,-2,-1,-1); } //(7) LV 10
		else if i<27 { sc_enemy_deck_addcard(i,-1,9,-2,-2,-2,-1,-1); } //(14) LV 9
		else if i<40 { sc_enemy_deck_addcard(i,-1,8,-2,-2,-2,-1,-1); } //(13) LV 8
	}
}
