...
if apply_event=true {
	...
	if event_kind=ref_event_levelup and card_id_space[0]!=-1 {
	...
	else if event_kind=ref_event_evolution and card_id_space[0]!=-1 {
		if card_id_space[0].card_evo[0]!=-1 and card_id_space[0].card_evo[0]<=normal_poke_id_max and card_id_space[0].card_innate>0 {
			do {
	...
	else if event_kind=ref_event_glyph and card_id_space[0]!=-1 {
	...
	else if event_kind=ref_event_tribute and card_id_space[0]!=-1 and card_id_space[1]!=-1 {
		if card_id_space[0].card_innate>0 and card_id_space[1].card_innate<innate_max and
		card_id_space[0].card_environment=false and card_id_space[1].card_environment=false {
			...
			if card_id_space[1].card_innate<=1 and random_innate_chance<1000 { random_innate_success=true; }
			else if card_id_space[1].card_innate=2 and random_innate_chance<925 { random_innate_success=true; }
			else if card_id_space[1].card_innate=3 and random_innate_chance<850 { random_innate_success=true; }
			else if card_id_space[1].card_innate=4 and random_innate_chance<775 { random_innate_success=true; }
			else if card_id_space[1].card_innate=5 and random_innate_chance<700 { random_innate_success=true; }
			//
