...
if tooltip_text!="" {
	if mouse_x+17+string_width(tooltip_text)<cam_x+cam_w {
		...
		sc_drawrectangle(mouse_x+9,mouse_y-4,mouse_x+18+string_width(tooltip_text),mouse_y+12,c_black,c_white,1,0.8,0);
		sc_drawtext(mouse_x+15,mouse_y-2,tooltip_text,make_colour_rgb(230,230,230),make_colour_rgb(40,40,40),1,0.5,0,-1);
	}
	else {
		draw_set_halign(fa_right);
		sc_drawrectangle(mouse_x-14-string_width(tooltip_text),mouse_y-4,mouse_x-5,mouse_y+12,c_black,c_white,1,0.8,0);
